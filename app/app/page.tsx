                            ...
                            <div className="space-y-3">
                                {Array.from({ length: 2 }).map((_, i) => (
                                    <div key={i} className="p-4 rounded-lg border border-gray-200 bg-white">
                                        ...
                                        <Skeleton className="h-3 w-[320px] max-w-full mb-2" />
    ...
    return (
        <>
            ...
            <div>
                ...
                <div className={`mb-6 p-4 rounded-lg border ${airtableStatus?.connected
                        ? 'bg-green-50 border-green-200'
                        : 'bg-yellow-50 border-yellow-200'
                    }`}>
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex items-start gap-3 flex-1">
                            <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${airtableStatus?.connected
                                    ? 'bg-green-100'
                                    : 'bg-yellow-100'
                                }`}>
                ...
                {topAction && (
                    <div className="mb-6 p-6 bg-orange-50 border-2 border-orange-400 rounded-lg shadow-md">
                        ...
                        <h2 className="text-3xl font-bold text-gray-900 mb-2">{formatPartnerName(topAction.partnerName)}</h2>
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex items-start gap-3 flex-1 min-w-0">
                                                ...
                                                <div className="flex flex-col items-center gap-1 shrink-0">
                                                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center font-bold text-xs ${priority.confidence === 'high'
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2 mb-1">
                                                        <h3 className="font-semibold text-gray-900 truncate">{formatPartnerName(priority.partnerName)}</h3>
                                                        {isStuck && (
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    {data?.atRisk?.slice(0, 2).map((item) => (
                                        ...
                                        >
                                            <h3 className="font-semibold text-gray-900 mb-1">{formatPartnerName(item.partnerName)}</h3>
